...
<title>Login to CEF</title>
<meta name="description" content="CEF website" />
...
<form id="login" method="post" action=""> 
    ...
    <div>
    	...
    	<input type="text" name="email" id="login_email" class="field required" title="Please provide your email" />
    </div>			
    ...
    <p class="back"><a href="login">Go back to login screen</a></p>
