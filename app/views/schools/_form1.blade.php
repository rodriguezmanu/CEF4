                                                    ...
                                                    <div class="Content">
                                                        <div id="_e11slg9_pnlContainer" class="SLGworkspace" style="">
                                                                    ...
                                                                    <table class="detailsTable">
																		...
																		<tr>
																		   <td class="label">
																			...
																			<td>
																				{{ Form::text('principal_first_name', null, ['style' => 'width: 180px', 'maxlength' => 40]) }}
																			</td>
																		   <td class="label">
																				{{ Form::label('principal_last_name', 'Last Name: ') }}
																			</td>
																			<td>
																				{{ Form::text('principal_last_name', null, ['style' => 'width: 180px', 'maxlength' => 40]) }}
																			</td>
																		</tr>
																		<tr>
																		   <td class="label">
																			...
																			<td colspan="3">
																				{{ Form::text('principal_email', null, ['style' => 'width: 180px', 'maxlength' => 40]) }}
																			</td>
																		</tr>
																		</tbody>
                                                                    </table>
                                                            ...
                                                            <div id="_e11slg9_lblButtons" style="margin-top: 15px; text-align: left; width: 100%;">
                                                                ...
                                                                &nbsp
																<button onClick="javascript: window.location='{{ URL::to('schools'); }}'">Cancel</button>
                                                            </div>
                                                        </div>
                                                    </div>
